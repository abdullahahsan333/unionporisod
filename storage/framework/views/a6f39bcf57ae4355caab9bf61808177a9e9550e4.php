            ...
            <div class="panel_container">
                ...
                <div class="panel_body">
                    <form action="<?php echo e(route('admin.tax-collection.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
						<div class="row">
                            <input type="hidden" name="type" value="bazar" class="form-control" readonly>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\unionprisod\resources\views/tax-collection/bazar.blade.php ENDPATH**/ ?>