                                ...
                                <?php endif; ?>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <select name="marital_status" class="form-control selectpicker" data-live-search="true" required>
                                            ...
                                            <?php $__currentLoopData = config('custom.maritalStatusBn'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <select name="marital_status_en" class="form-control selectpicker" data-live-search="true" required>
                                            ...
                                            <?php $__currentLoopData = config('custom.maritalStatusEn'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <select name="religion_en" class="form-control selectpicker" data-live-search="true" required>
                                            ...
                                            <?php $__currentLoopData = config('custom.religionEn'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value); ?>"><?php echo e(strFilter($value)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\unionprisod\resources\views/affidavit/new_affidavit.blade.php ENDPATH**/ ?>