            ...
            <div class="panel_container">
                ...
                <div class="panel_body">
                    <form action="<?php echo e(route('admin.affidavit.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea id="summernote" name="all_data"><?php echo e((!empty($familyData[0]->all_data) ? $familyData[0]->all_data : "")); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <?php if(!empty($familyData[0]->id)): ?>
                            <input type="hidden" name="id" value="<?php echo e($familyData[0]->id); ?>" >
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\unionprisod\resources\views/affidavit/family.blade.php ENDPATH**/ ?>