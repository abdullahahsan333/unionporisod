<?php $__env->startSection('content'); ?>
    ...
    <div class="body_container" ng-controller="carectureCertificateController" ng-cloak>
        ...
        <div class="body_content">
            <div class="panel_container">
                <div class="panel_heading">
                    <h4>বার্ষিক সনদপত্র যোগ করুন</h4>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label>পিতা/স্বামীর পেশা</label>
                                        <input type="text" name="father_profession" value="" class="form-control" required>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label>Father / Husband Profession</label>
                                        <input type="text" name="father_profession_en" value="" class="form-control" required>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input inputmode="numeric" pattern="[0-9]*" type="number" ng-model="monthlyIncome" name="monthly_income" class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input inputmode="numeric" pattern="[0-9]*" type="number" name="yearly_income" ng-value="monthlyIncome*12" class="form-control" readonly>
                                </div>
                            </div>

                            <input type="hidden" name="affidavit_type" value="income_certificate">
...
<script>
        app.controller('carectureCertificateController', function($scope) {});
        // Uniqe Holding No
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\unionprisod\resources\views/affidavit/income.blade.php ENDPATH**/ ?>