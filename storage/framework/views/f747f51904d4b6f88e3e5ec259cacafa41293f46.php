<?php $__env->startSection('content'); ?>
    ...
    <div class="body_container" ng-controller="unmarriedCertificateController" ng-cloak>
        ...
        <div class="body_content">
            <div class="panel_container">
                <div class="panel_heading">
                    <h4>অবিবাহিত সনদপত্র যোগ করুন</h4>
                </div>
                <div class="panel_body">
                    <form action="<?php echo e(route('admin.affidavit.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php endif; ?>
                                    ...
                                    <div class="form-group" >
                                        <label>পৌরসভা<span class="text-danger"></span></label>
                                        <select name="pourashava_id" id="pourashavaId" onchange="getPourashavaEnName()" class="form-control selectpicker" data-live-search="true" >
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label>Pourashava <span class="text-danger">&nbsp;</span></label>
                                        <input id="pourashavaIdEn" class="form-control" readonly>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="affidavit_type" value="unmarried_certificate">
...
<?php $__env->startPush('footer-script'); ?>
    <script>
        app.controller('unmarriedCertificateController', function($scope) {});
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\unionprisod\resources\views/affidavit/unmarried.blade.php ENDPATH**/ ?>