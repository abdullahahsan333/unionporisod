        ...
        <div class="body_content">
            <div class="panel_container">
                ...
                <div class="panel_body">
                    ...
                    <form action="<?php echo e(route('admin.reports.bazar_member')); ?>" method="post" class="d-print-none">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                    ...
                    <div class="table-responsive" id="page-content">
                        <table class="table table-bordered" id="DataTable">
                            <tr>
                                ...
                                <th rowspan="2">ঘর মালিকের নাম</th>
                                <th rowspan="2">পিতা/স্বামীর নাম</th>
                                <th rowspan="2">ভাডাটিয়ার নাম</th>
                                <th rowspan="2">ভাডাটিয়ার পিতা/স্বামীর নাম</th>
                                <th rowspan="2">ওয়ার্ড নং / হোল্ডিং নং</th>
                                <th rowspan="2">ব্যবসার নাম</th>
                                <th rowspan="2">বাজারের নাম</th>
                                <th rowspan="2">বার্ষিক মূল্যায়ণ</th>
                            ...
                            <?php if(!empty($results) && $results->isNotEmpty()): ?>
                                ...
                                <?php ($totalAmount += $row->total_taxes); ?>
                                <?php ($ward = $wards->where('id', $row->ward_id)->first()); ?>
                                <tr>
                                    <td class="text-center"><?php echo e(numberFilter(++$key,'bn')); ?></td>
                                    <td><?php echo e($row->holder_name); ?></td>
                                    <td><?php echo e($row->father_name); ?></td>
                                    <td><?php echo e($row->tenant_name); ?></td>
                                    <td><?php echo e($row->tenant_father_name); ?></td>
                                    <td><?php echo e((!empty($ward) ? $ward->name_bn : "")); ?> (<?php echo e(numberFilter($row->holding_no,'bn')); ?>)</td>
                                    <td><?php echo e($row->business_name); ?></td>
                                    <td><?php echo e($row->bazar_name); ?></td>
                            ...
                            <?php endif; ?>
                            <tr>
                                <th colspan="9" class="text-right">মোট </th>
...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script src="<?php echo e(asset('backend')); ?>/js/FileSaver.js"></script> 
    <script src="<?php echo e(asset('backend')); ?>/js/jquery.wordexport.js"></script> 
    <script>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\unionprisod\resources\views/reports/bazar_member.blade.php ENDPATH**/ ?>