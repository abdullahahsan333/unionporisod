        ...
        <div class="body_content">
            <div class="panel_container">
                <div class="panel_heading">
                    <h4>চারিত্রিক সনদপত্র যোগ করুন</h4>
                </div>
                <div class="panel_body">
                    <form action="<?php echo e(route('admin.affidavit.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        <label>পোষ্ট কোড <span class="text-danger">*</span></label>
                                        <input type="text" name="post_code" ng-model="postCodeEn" class="form-control" required>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="postCodeEn" ng-value="postCodeEn" class="form-control" readonly>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="affidavit_type" value="carecture_certificate">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\unionprisod\resources\views/affidavit/carecture.blade.php ENDPATH**/ ?>