    ...
    <script>
        ...
        function getUpazilaFn() {
            ...
            $.ajax({
                ...
                data: {id: _predistrictId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getUnionFn() {
            ...
            $.ajax({
                ...
                data: {id: _preUpazilaId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getParUpazilaFn() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.upazila-list')}}",
                data: {id: _parDistrictId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getParUnionFn() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.union-list')}}",
                data: {id: _parUpazilaId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getUnionEnName() {
            ...
            $.ajax({
                ...
                data: {id: _preUnionId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getWardEnName() {
            ...
            $.ajax({
                ...
                data: {id: _preWardNo, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getParUnionEnName() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.union-name')}}",
                data: {id: _parUnionId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getParWardEnName() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.ward-name')}}",
                data: {id: _parWardNo, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
