                        ...
                        <table class="table table-bordered list-table" id="DataTable">
                            ...
                            @if(!empty($results))
                                ...
                                <?php $totalBalance += $row->balance; ?>
                                    <tr>
                                        ...
                                        <td> {{ (!empty($row->annual_assessment) ? numberFilter($row->annual_assessment,'bn') : "0") }} টাকা</td>
                                        <td> {{ numberFilter($row->balance,'bn') }} টাকা</td>
                                        <td class="operation_btn text-right print_hide">
                                            <?php //if(($privilege == 'super') ||  (!empty($accessList->notice->submenu->action->view) && $accessList->notice->submenu->action->view == "view")) { ?>
                                                <a href="{{route('admin.notice.view', $row->id)}}" class="view" title="View">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>{{ numberFilter($annualAssessment,'bn') }} টাকা</th>
                                    <th>{{ numberFilter($totalBalance,'bn') }} টাকা</th>
