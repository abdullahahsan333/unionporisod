    ...
    <div class="section_cover">
        <div class="credential_div">
            <div class="form_box">
                ...
                <a style="width: 100%;" href="{{asset('backend')}}/app/amaruptax.apk" class="btn btn-danger" download>Download Mobile App ! Click Here</a>
            </div>
        </div>
            ...
            <div class="container_box">
                ...
                <div class="company_info">
                    <div class="info" style="border-bottom: none;">
                        ...
                        <p>ঠিকানাঃ {{ $siteInfo->address }}</p>
                        <p>মোবাইলঃ {{ $siteInfo->mobile }}</p>
                        <p>ই-মেইলঃ {{ $siteInfo->email }}</p>
                        <!--{{ $siteInfo->youtube }} {{ $siteInfo->facebook }} {{ $siteInfo->twitter }}-->
                    </div>
