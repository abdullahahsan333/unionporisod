                    ...
                    <form action="{{route('admin.affidavit.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marriage_date" value="{{ date('Y-m-d') }}" class="form-control datepicker" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dob" ng-model="dob" value="{{ date('Y-m-d') }}" class="form-control datepicker" required>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                @else
                                    <input type="hidden" name="wife_district_id" value="{{$userInfo->district_id}}" id="wifeDistrictId">
                                    <input type="hidden" name="wife_upazila_id" value="{{$userInfo->upazila_id}}" id="wifeUpazilaId">
                                    <input type="hidden" name="wife_union_id" value="{{$userInfo->union_id}}" id="wifeUnionId">
                                @endif
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ragi_date" ng-model="regiDate" value="{{ date('Y-m-d') }}" class="form-control datepicker" required>
                                    </div>
    ...
    <script>
        ...
        function getWifeUpazilaFn() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.upazila-list')}}",
                data: {id: _wifeDistrictId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getPourashavaFn() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.pourashava-list')}}",
                data: {id: _districtId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getWifeUnionFn() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.union-list')}}",
                data: {id: _wifeUpazilaId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getPourashavaEnName() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.pourashava-name')}}",
                data: {id: _pourashavaId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getWifeUnionEnName() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.union-name')}}",
                data: {id: _wifeUnionId, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
        ...
        function getWifeWardEnName() {
            ...
            $.ajax({
                method: "POST",
                url: "{{route('admin.member.ward-name')}}",
                data: {id: _wifeWardNo, _token: "{{ csrf_token() }}"}
            }).then(function (response) {
