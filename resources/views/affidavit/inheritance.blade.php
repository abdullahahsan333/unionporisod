            ...
            <div class="panel_container">
                ...
                <div class="panel_body">
                    <form action="{{route('admin.affidavit.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea id="summernote" name="all_data">{{ (!empty($inheritData[0]->all_data) ? $inheritData[0]->all_data : "") }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            @if(!empty($inheritData))
                            <input type="hidden" name="id" value="{{ $inheritData[0]->id }}" >
                            @endif
