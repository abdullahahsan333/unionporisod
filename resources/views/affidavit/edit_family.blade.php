        ...
        <div class="body_content">
            <div class="panel_container">
                <div class="panel_heading">
                    <h4>পারিবারিক সনদ পরিবর্তন করুন</h4>
                </div>
                <div class="panel_body">
                    <form action="{{route('admin.affidavit.update')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea id="summernote" name="all_data">{{ (!empty($info->all_data) ? $info->all_data : "") }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="affidavit_no" value="{{ $info->affidavit_no }}" >
